...
public class PStats {
    ...
    public PStats(Player p) {
        ...
        if (!this.file.exists()) {
            ...
            data.set("Main.Stats.VITALITY", 1);
            ...
            data.set("Main.Stats.FARMING_FORTUNE", 100);
            data.set("Main.Stats.MINING_SPEED", 100);

            data.set("Main.Stats.DAMAGE", 100);
